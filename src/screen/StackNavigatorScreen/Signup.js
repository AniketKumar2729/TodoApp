...
const Signup = ({ navigation }) => {
    ...
    // const handleSignup=()=>navigation.navigate("ParentofBottomNav")
        ...
        <View className='flex-1 bg-white items-center'>
            ...
            <KeyboardAvoidingView behavior="padding">
                <View className='items-center'>
                    <Text className='text-lg font-semibold mt-5'>Signup in to Your Account</Text>
                </View>
                <View className='mt-5'>
                    ...
                    <View className='mt-14'>
                        ...
                        <Text className='text-center text-lg text-gray-600 mt-1'>
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate("Login")}>
                                <Text className='text-blue-600 font-bold text-center'> Login</Text>
                            </TouchableOpacity>
                        </Text>
                    </View>
                </View>
